...
define("DETECTIONS_PHP_URL", "http://www.familiecoenen.nl/detections/detections2.php");
...
function askPassword($my_password) {
    print "<div class='w3-container w3-card w3-center w3-pale-purple w3-text-purple w3-margin-top w3-margin-bottom w3-padding-4'>";
    print "<form method='post' target='_self'>";
    print "<label for='mypwd'>Password: </label>";
    print "<input type='text' id='mypwd' name='mypwd' value='$my_password'>";
...
$basepath = getcwd();
$my_password = getSubmittedPassword();
